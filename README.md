...
VGPI Dataset
----------------------
VGPI (Visual Grounding on Pick-and-place Instruction) is a visual grounding dataset consisting:
...
Data were collected from two distinct environments:

**ENV1**
| Name  | Content | Examples | Size | Link |
| --- | --- |--- | --- |--- |
| `ddd.zip`  | ENV1 training set images | 540 | 00 MBytes | [Download]()|
| `ddd.zip`  | pick instructions (generated by GVCCI) | 97,448 | 00 MBytes | [Download]()|
| `ddd.zip`  | place instructions (generated by GVCCI) | 114,422 | 00 MBytes | [Download]()|
| `ddd.zip`  | Test-H | 212 | 00 KBytes | [Download]()|
| `ddd.zip`  | Test-R | 180 | 00 MBytes | [Download]()|

**ENV2**
| Name  | Content | Examples | Size | Link |
| --- | --- |--- | --- |--- |
| `ddd.zip`  | ENV2 training set images | 135 | 00 MBytes | [Download]()|
| `ddd.zip`  | pick instructions (generated by GVCCI) | 19,511 | 00 MBytes | [Download]()|
| `ddd.zip`  | place instructions (generated by GVCCI) | 20,999 | 00 MBytes | [Download]()|
| `ddd.zip`  | Test-E | 68 | 00 KBytes | [Download]()|
