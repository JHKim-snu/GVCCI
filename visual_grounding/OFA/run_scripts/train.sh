...
dataset_name=ENV1_train
log_dir=./logs
save_dir=../data/OFA_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../utils/BPE
user_dir=../ofa_module

data=../../data/train/ENV1_train.tsv,../../data/train/ENV1_train.tsv
restore_file=../../data/OFA_checkpoints/refcoco_large_best.pt
